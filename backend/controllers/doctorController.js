...
const appointmentsDoctor = async (req, res) => {
    try {
        const docId = req.docId || req.body.docId || req.query.docId
        if (!docId) {
...
export {changeAvailability, doctorList, loginDoctor,
     appointmentsDoctor, doctorDashboard, appointmentComplete, 
     appointmentCancel, doctorProfile, updateDoctorProfile}

// this is here beacuse admin and both docotors can use this
