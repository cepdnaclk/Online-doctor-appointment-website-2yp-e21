      ...
      <form onSubmit={onSubmitHandler} className="m-5 w-full">
        ...
        <div className="bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll">
          ...
          <div className="mt-4">
            ...
            <textarea onChange={(e) => setAbout(e.target.value)} value={about} className="w-full px-4 pt-2 border rounded" placeholder="write about doctor details" rows={5} required />
          </div>
